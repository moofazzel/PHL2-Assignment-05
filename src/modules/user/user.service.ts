...
export class UserService {
  static async getAllUsers(query: any): Promise<UserListResponse> {
    const {
      page = 1,
      limit = 10,
      sortBy = "createdAt",
  ...
  static async getAllAgents(query: any): Promise<UserListResponse> {
    const {
      page = 1,
      limit = 10,
      sortBy = "createdAt",
  ...
  static async toggleAgentApproval(
    agentId: string
  ): Promise<{ success: boolean; message: string }> {
